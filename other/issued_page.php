...
<html>
	...
	<body style="margin-left:40px;">
		<br><br>
		<form action="push/upload_record.php?department=<?php echo $department;?>" method="post" onkeypress="return event.keyCode != 13;">
...
<script>
	$(document).ready(function()
	{
		...
		$("#name").bind('keyup change',function()
		{
			...
			var dataString = 'department=<?php echo $department;?>&name='+name;console.log(dataString);
			$.ajax
			({
				type: "POST",
				url: "get/get_batch_mfg_exp.php",
				data: dataString,
				cache: false,
		...
		$('#issue_quantity').bind('change keyup', function()
		{
